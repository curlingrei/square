...
ActiveRecord::Schema.define(version: 20_201_231_014_937) do
  ...
  create_table 'booklikes', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[user_id bookpost_id], name: 'index_booklikes_on_user_id_and_bookpost_id', unique: true
  ...
  create_table 'commentlikes', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[user_id bookcomment_id], name: 'index_commentlikes_on_user_id_and_bookcomment_id', unique: true
  ...
  create_table 'groupcommentlikes', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[user_id groupcomment_id], name: 'index_groupcommentlikes_on_user_id_and_groupcomment_id', unique: true
  ...
  create_table 'participates', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[user_id group_id], name: 'index_participates_on_user_id_and_group_id', unique: true
